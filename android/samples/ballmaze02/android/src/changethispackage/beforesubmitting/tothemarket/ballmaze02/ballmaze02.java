package changethispackage.beforesubmitting.tothemarket.ballmaze02;
...
public class ballmaze02 extends PApplet {

//*********************************************************************************
// this is designed to work with arduino patch, ballmaze05.pde
//*********************************************************************************
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public void listdevices(String thisText, int c) {
...
public void sendData() {
  ...
  try {
    ...
    ons.write(PApplet.parseInt((ax+10)*5));  // converts -10 to 10, to 0 to 100
    ons.write(PApplet.parseInt((ay+10)*5));  // converts -10 to 10, to 0 to 100
